...
def imgtest():
    ...
    model = YOLO('runs/detect/stuat/weights/best.pt')
...
def main_account_screen():
    ...
    main_screen.title("Student Attention   Detection ")

    Label(text=" Student Attention   Detection", width="300", height="5", font=("Calibri", 16)).pack()
